	...
	return (
		<div className="w-[411px] h-[542px] rounded-lg overflow-hidden shadow-lg bg-white flex flex-col text-start  ">
			...
			<div className="p-4 flex flex-grow flex-col">
				...
				<p className="text-[#8C8C8C] font-semibold text-[17px]  flex items-center gap-2 mb-2">
				...
				<p className="text-[#8C8C8C] text-sm mt-2">{descricao}</p>
				<button className="mt-auto w-full bg-blue-600 text-white font-semibold py-2 rounded-md hover:bg-blue-700 transition">
					Visualizar
				</button>
			</div>
		</div>
